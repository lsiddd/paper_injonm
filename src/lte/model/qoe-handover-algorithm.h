...
#ifndef QOE_HANDOVER_ALGORITHM_H
#define QOE_HANDOVER_ALGORITHM_H
 ...
 */
class QoeHandoverAlgorithm : public LteHandoverAlgorithm
{
public:
  /// Creates an A2-A4-RSRQ handover algorithm instance.
  QoeHandoverAlgorithm ();

  virtual ~QoeHandoverAlgorithm ();
  ...
  friend class MemberLteHandoverManagementSapProvider<QoeHandoverAlgorithm>;
...
}; // end of class QoeHandoverAlgorithm
