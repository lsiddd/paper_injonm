...
#ifndef MULTI_HANDOVER_ALGORITHM_H
#define MULTI_HANDOVER_ALGORITHM_H
 ...
 */
class MultiHandoverAlgorithm : public LteHandoverAlgorithm
{
public:
  /// Creates an A2-A4-RSRQ handover algorithm instance.
  MultiHandoverAlgorithm ();

  virtual ~MultiHandoverAlgorithm ();
  ...
  friend class MemberLteHandoverManagementSapProvider<MultiHandoverAlgorithm>;
...
}; // end of class MultiHandoverAlgorithm
