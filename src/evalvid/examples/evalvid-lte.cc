...
main (int argc, char *argv[])
{
  ...
  uint16_t port = 8000;
   ...
   CommandLine cmd;
   cmd.AddValue ("distance", "distante", distance);
   cmd.Parse (argc, argv);
  ...
  Ptr<ListPositionAllocator> nodeAlloc = CreateObject<ListPositionAllocator> ();
  ...
  MobilityHelper nodeMobil;
  nodeMobil.SetMobilityModel("ns3::ConstantPositionMobilityModel");
  nodeMobil.SetPositionAllocator(nodeAlloc);
  nodeMobil.Install(ueNodes);
