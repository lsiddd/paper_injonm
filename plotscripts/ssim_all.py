...
if (chart_type == 'bar'):
	...
	means = (	np.float(np.mean(c_ssim_ahp)/4),
				...
				np.float(np.mean(a_ssim_a2a4)/4),
				0,
				np.float(np.mean(c_ssim_a3)/4),
				np.float(np.mean(h_ssim_a3)/4),
				np.float(np.mean(a_ssim_a3)/4)
				)

	std = (		np.float(np.std(c_ssim_ahp_std)/4),
				np.float(np.std(h_ssim_ahp_std)/4),
				np.float(np.std(a_ssim_ahp_std)/4),
				0,
				np.float(np.std(c_ssim_a2a4_std)/4),
				np.float(np.std(h_ssim_a2a4_std)/4),
				np.float(np.std(a_ssim_a2a4_std)/4),
				0,
				np.float(np.std(c_ssim_a3_std)/4),
				np.float(np.std(h_ssim_a3_std)/4),
				np.float(np.std(a_ssim_a3_std)/4),
				)
	...
	rects1 = ax.bar(ind, means, width, color=('blue', '#ed4728', '#8dc63f', 'white','blue', '#ed4728', '#8dc63f', 'white', 'blue', '#ed4728', '#8dc63f'), yerr=std, error_kw=dict(ecolor='black', lw=2, capsize=3, capthick=3))
