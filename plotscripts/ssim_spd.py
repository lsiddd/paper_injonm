...
def aaa(mType, upper, topper, filename):
	chart_type = 'bar'
	#Video = 'Container'
	#mType = 'VQM'
	...
	if (chart_type == 'bar'):
		...
		autolabel(rects1)
		#plt.show()
		plt.savefig(f'{mType.lower()}_{filename}_barchart.pdf')
...
aaa("VQM", 1, 11, "slow")
aaa("VQM", 11, 21, "medium")
aaa("VQM", 21, 31, "fast")
aaa("SSIM", 1, 11, "slow")
aaa("SSIM", 11, 21, "medium")
aaa("SSIM", 21, 31, "fast")